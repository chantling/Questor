...
namespace DirectEve.PySharp
{
    ...
    public partial class PyObject
    {
        ...
        internal PyObject(PySharp pySharp, IntPtr pyReference, bool newReference, string attributeName = "")
        {
        ...
        /// <summary>
        ///     Does this python object has this attribute strng?
        /// </summary>
        /// <remarks>
        ///     -----
        /// </remarks>
        ...
        public PyObject Attribute(string attribute)
        {
            ...
            if (!HasAttrString(attribute))
            {
                ...
                if (DirectEve._enableLoggingNotExistingAttributes)
                {
                    if (_attributeName != string.Empty)
                    {
                        Console.WriteLine("Attribute doesn't exist: current attribute: " + _attributeName + " follwing attribute: " + attribute);
                    }
                    else
                    {
                        Console.WriteLine("Attribute doesn't exist: " + attribute);
                    }
                }
                return PySharp.PyZero;
            }
        ...
        public PyObject Call(string function, params object[] parms)
        {
            ...
            if (!func.IsValid || !this.IsCallable(func._pyReference))
            {
                if (DirectEve._enableLoggingNotExistingFunctions)
                    Console.WriteLine("Function couldn't be called: " + function);
                return PySharp.PyZero;
            }
        ...
        public bool PySet_Contains<T>(T value)
        {
            ...
            try
            {
                if (GetPyType() == PyType.SetType)
                {
                    //Console.WriteLine("This is a set.");
