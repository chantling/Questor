    ...
    public class DirectEntity : DirectInvType
    {
        ...
        public bool HasExploded
        {
            get
            {
                ...
                PyObject obj = _ball.Attribute("exploded");
                if (obj.IsValid)
                {
                ...
                {
                    Console.WriteLine("HasExploded attribute is not valid!");
                    _hasExploded = false;
                }
        ...
        public bool HasReleased
        {
            get
            {
                ...
                PyObject obj = _ball.Attribute("released");
                if (obj.IsValid)
                {
                ...
                {
                    Console.WriteLine("HasReleased attribute is not valid!");
                    _hasReleased = false;
                }
        ...
        internal static Dictionary<long, DirectEntity> GetEntities(DirectEve directEve)
        {
            ...
            foreach (var id in balls)
            {
                ...
                // Create the entity
                if (slimItem.IsValid && ball.IsValid && !(bool)ball.Attribute("exploded") && !(bool)ball.Attribute("released"))
        ...
        public bool Approach()
        {
            ...
            if (!DirectEve.IsTargetBeingRemoved(this.Id)) {
