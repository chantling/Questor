...
{
    partial class QuestorManagerUI
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
        	...
        	this.JobHeader1 = new System.Windows.Forms.ColumnHeader();
        	this.DescriptionHeader1 = new System.Windows.Forms.ColumnHeader();
        	...
        	this.JumpsHeader = new System.Windows.Forms.ColumnHeader();
        	...
        	this.chQuantitySold = new System.Windows.Forms.ColumnHeader();
        	this.chMedianBuy = new System.Windows.Forms.ColumnHeader();
        	this.chStationBuy = new System.Windows.Forms.ColumnHeader();
        	this.chTotalBuy = new System.Windows.Forms.ColumnHeader();
        	...
        	this.BttnStart.Click += new System.EventHandler(this.BttnStartClick);
        	// 
        	// LstTask
        	// 
        	...
        	this.chkUpdateMineral.Location = new System.Drawing.Point(256, 33);
        	...
        	this.RefineCheckBox.Text = "Check Refine";
